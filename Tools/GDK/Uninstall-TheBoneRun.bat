...
title Uninstall The Bone Runner
cd /d "%~dp0"

echo ========================================
echo Uninstall The Bone Runner
echo ========================================
...
if not defined PFN (
  echo.
  echo The Bone Runner is not registered with wdapp right now.
...
echo.
set /p CONFIRM=Uninstall The Bone Runner? [Y/n]
...
echo The Bone Runner was uninstalled.
